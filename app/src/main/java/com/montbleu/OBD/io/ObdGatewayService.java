...
import com.montbleu.OBD.activity.ConfigActivity;
import com.montbleu.OBD.activity.MainActivity;
...
public class ObdGatewayService extends AbstractGatewayService {
     ...
     */
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_starting), R.drawable.obd_icon, true, true, false);
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_started), R.drawable.obd_icon, true, true, false);
        }
    }

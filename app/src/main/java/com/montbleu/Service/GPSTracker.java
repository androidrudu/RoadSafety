...
public class GPSTracker extends Service  {
    ...
    public void LocationUpdatesService() {
    }
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (!mChangingConfiguration && Util_functions.requestingLocationUpdates(this)) {
    ...
    public void removeLocationUpdates() {
        ...
        try {
            ...
            Util_functions.setRequestingLocationUpdates(this, true);
    ...
    private Notification getNotification() {
        ...
        PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, RoadStartPageActivity.class), PendingIntent.FLAG_IMMUTABLE);


/*        Intent stopSelf = new Intent(this, GPSTracker.class);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
               /* .addAction(R.drawable.ic_launch, getString(R.string.launch_activity),
                ...
                .setContentText(text)
                .setContentTitle(Util_functions.getLocationTitle(this))
                .setOngoing(true)
                .setPriority(Notification.PRIORITY_HIGH)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setTicker(text)
                .setWhen(System.currentTimeMillis());
                .addAction(R.drawable.ic_launch, getString(R.string.stop_drive),
                        servicePendingIntent)*/
                .setContentTitle("Rudu")
                //.setContentTitle(text)
                .setContentText("Safe Drive")
                .setPriority(Notification.FLAG_FOREGROUND_SERVICE)
                .setSmallIcon(R.mipmap.road_icon_new)
                .setTicker(text)
                .setAutoCancel(true)
       ...
       //  builder .addAction(R.drawable.ic_cancel,"Hide", pStopSelf);
    ...
    private void SavetoServer(){
        ...
        Log.d("resMLLL", String.valueOf(speed));
        Log.d("resMLLLL", String.valueOf(direction));

package com.example.library_thermo;
...
public class ThermometerView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        viewBg = typedArray.getColor(R.styleable.ThermometerView_viewBg, Color.parseColor("#000000"));
        unitTextSize = typedArray.getDimension(R.styleable.ThermometerView_unitTextSize, 36f);
        unitTextColor = typedArray.getColor(R.styleable.ThermometerView_unitTextColor, Color.parseColor("#000000"));
        scaleTextSize = typedArray.getDimension(R.styleable.ThermometerView_scaleTextSize, 18f);
        scaleTextColor = typedArray.getColor(R.styleable.ThermometerView_scaleTextColor, Color.parseColor("#000000"));
        maxScaleLineColor = typedArray.getColor(R.styleable.ThermometerView_maxScaleLineColor, Color.parseColor("#000000"));
        midScaleLineColor = typedArray.getColor(R.styleable.ThermometerView_midScaleLineColor, Color.parseColor("#000000"));
        minScaleLineColor = typedArray.getColor(R.styleable.ThermometerView_minScaleLineColor, Color.parseColor("#000000"));
        ...
        thermometerShadowBg = typedArray.getColor(R.styleable.ThermometerView_thermometerShadowBg, Color.parseColor("#000000"));
        ...
        leftMercuryBg = typedArray.getColor(R.styleable.ThermometerView_leftMercuryBg,  Color.parseColor("#ffffff"));
        rightMercuryBg = typedArray.getColor(R.styleable.ThermometerView_rightMercuryBg,  Color.parseColor("#ffffff"));
        leftMercuryColor = typedArray.getColor(R.styleable.ThermometerView_leftMercuryColor, Color.parseColor("#FC4300"));
        rightMercuryColor = typedArray.getColor(R.styleable.ThermometerView_rightMercuryColor, Color.parseColor("#FC4300"));
    ...
    public static class ThermometerBuilder {
        ...
        private int viewBg = Color.parseColor("#000000"); // 背景颜色
